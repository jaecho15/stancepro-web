      ...
      cards: [
        {
          ...
          points: [
            ...
            "Direct Request Only — 코치를 직접 지목한 라이더만",
        ...
        },
        {
          ...
          points: [
            ...
            "2시간 안에 아무도 수락하지 않으면 다시 보냄 — 최대 세 번까지",
          ],
        },
        {
          title: "수락까지 2시간",
    ...
    apply: {
      ...
      steps: [
        ...
        },
        {
          ...
          points: [
            "제시된 샘플 클립 중 하나 선택",
            "실제 고객 라이더에게 하듯 그대로 리뷰 — 음성, 그림, 짧은 글",
