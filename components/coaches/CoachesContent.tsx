  ...
  en: {
    ...
    routing: {
      ...
      cards: [
        ...
        {
          title: "How the queue ranks you",
          points: [
            "Auto-assign lines up the coaches who are Open to Requests and eligible for that session, then offers it to whoever is in front",
            "You stand further forward the fewer sessions you have taken on in the last 24 hours",
            "Then the shorter your turnaround — accepting a session to delivering the review, not how fast you answer an offer",
            "Then the longer it has been since you last took one on",
            "Star rating is the fourth and last key — it only comes into play when all three above are level",
            "At 3 active sessions you drop out of the line — 2 when the request is Advanced Coaching, and a review you have delivered still counts until the session closes",
          ],
        },
      ],
  ...
  ko: {
    ...
    routing: {
      ...
      cards: [
        ...
        {
          title: "제안 순서가 정해지는 기준",
          points: [
            "자동 배정은 Open to Requests 상태이면서 그 세션을 맡을 수 있는 코치만 줄을 세우고, 맨 앞 코치에게 제안",
            "최근 24시간 동안 맡은 세션이 적을수록 앞",
            "그다음은 수락한 뒤 리뷰를 전달하기까지 걸린 평균 시간이 짧을수록 앞 — 제안에 답하는 속도가 아님",
            "그다음은 마지막으로 세션을 맡은 지 오래됐을수록 앞",
            "별점은 네 번째이자 마지막 기준 — 앞의 세 가지가 모두 같을 때만 순서에 작용함",
            "진행 중인 세션이 3건이 되면 줄에서 빠짐 — Advanced Coaching 요청이면 2건, 전달을 마친 리뷰도 세션이 닫힐 때까지 포함",
          ],
        },
      ],
