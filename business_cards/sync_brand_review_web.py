...
OFFICIAL_STICKER_PREVIEWS: tuple[tuple[str, str], ...] = (
    ...
    ("sticker_lockup_tagline_navy_5.5x2in_preview.png", "Lockup + tagline — navy"),
    ...
    (
        ...
        "Lockup + tagline die-cut — light (navy ink)",
    ),
    (
        "sticker_lockup_tagline_diecut_dark_5.5x2in_preview.png",
        "Lockup + tagline die-cut — dark (white ink)",
    ),
    ("sticker_snowboard_diecut_6x1.5in_preview.png", "Die-cut 6×1.5 — light (navy ink)"),
    (
        "sticker_snowboard_diecut_dark_board_6x1.5in_preview.png",
        "Die-cut 6×1.5 — dark (white ink)",
    ),
    ("sticker_snowboard_diecut_10x2.5in_preview.png", "Die-cut 10×2.5 — light (navy ink)"),
    (
        "sticker_snowboard_diecut_dark_board_10x2.5in_preview.png",
        "Die-cut 10×2.5 — dark (white ink)",
    ),
